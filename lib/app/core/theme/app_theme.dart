...
class AppTheme {
  static ThemeData getTheme(String languageCode, Brightness brightness) {
    ...
    final Color buttonSecondaryBg = isDarkMode
        ? AppColors.darkButtonSecondaryBg
        : AppColors.lightButtonSecondaryBg;

    final Color inputBgColor =
        isDarkMode ? AppColors.darkInputBg : AppColors.lightInputBg;
    ...
    final textTheme = TextTheme(
      displayLarge: TextStyle(
          ...
          color: primaryTextColor), // H1

      displayMedium: TextStyle(
          fontFamily: fontFamily,
          fontSize: 24.0,
          fontWeight: FontWeight.w700,
          color: primaryTextColor), // H2

      displaySmall: TextStyle(
          fontFamily: fontFamily,
          fontSize: 20.0,
          fontWeight: FontWeight.w600,
          color: primaryTextColor), // H3
      ...
      bodyMedium: TextStyle(
          ...
          fontSize: 14.0,
          fontWeight: FontWeight.w600,
          color: secondaryTextColor), // small text
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        backgroundColor: isDarkMode
            ...
            : AppColors.lightBg.withValues(alpha: 0.65),
        elevation: 0,
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          // هذا هو السلوك عند التركيز - يتطابق مع الهوية
