...
import 'package:meding_app/features/community/screens/community_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    switch (_currentPage) {
      ...
      case NavPage.community:
        bodyContent = const CommunityScreen();
    ...
    final List<Widget> sections = [
      ...
      HomeSection(
        ...
        children: const [
          ArticleListItem(
            ...
            readTime: "5 دقائق",
            imageUrl:
                'https://images.unsplash.com/photo-1551601651-2a8555f1a136?q=80&w=1982',
          ),
          ArticleListItem(
            ...
            readTime: "8 دقائق",
            imageUrl:
                'https://images.unsplash.com/photo-1579165466949-518dd7627104?q=80&w=2070',
          ),
          ArticleListItem(
            title: "دراسة حالة: تأثير التغذية على أمراض القلب",
            author: "فريق Meding",
      ...
      HomeSection(
        ...
        children: const [
          ...
          SuggestedLessonCard(
              title: "درس الكيمياء", instructor: "أ. سارة خالد"),
