            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: const [
                  ...
                  CourseCard(title: "Anatomy Course", instructor: "Dr. Ahmed Ali"),

                  CourseCard(title: "Medical Basics", instructor: "Dr. Fatima Mohamed"),
...
class CourseCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(height: 96, decoration: BoxDecoration(color: imagePlaceholderColor, borderRadius: BorderRadius.circular(8.0))),

            const SizedBox(height: 8),

            Text(title, style: TextStyle(color: textColor, fontWeight: FontWeight.bold, fontFamily: 'Cairo', fontSize: 16), maxLines: 1, overflow: TextOverflow.ellipsis),

            const SizedBox(height: 4),

            Text(instructor, style: TextStyle(fontSize: 14, color: subtextColor, fontFamily: 'Cairo'), maxLines: 1, overflow: TextOverflow.ellipsis),
    ...
    // --- Otherwise (if it's light mode), we'll show the transparent glass design ---
      ...
      final imagePlaceholderColor = Colors.white.withOpacity(0.4);
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(instructor, style: TextStyle(fontSize: 14, color: textColor.withOpacity(0.8), fontFamily: 'Cairo'), maxLines: 1, overflow: TextOverflow.ellipsis),
