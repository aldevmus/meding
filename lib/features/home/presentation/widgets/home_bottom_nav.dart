...
class HomeBottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final barColor = (isDarkMode ? AppColors.darkSurface : Colors.white).withOpacity(0.85);

    final borderColor = isDarkMode ? Colors.white.withOpacity(0.15) : Colors.grey.shade300.withOpacity(0.5);
...
class _NavItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final activeBgColor = (isDarkMode ? AppColors.primaryBlue.withOpacity(0.2) : AppColors.primaryBlue.withOpacity(0.1));

    final activeIconAndTextColor = isDarkMode ? AppColors.primaryBlueAccent : AppColors.primaryBlue;
