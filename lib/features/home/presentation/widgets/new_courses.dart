...
class CourseCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cardBackgroundColor = isDarkMode ? AppColors.darkSurface : Colors.white;
    ...
    final imagePlaceholderColor = isDarkMode ? AppColors.darkBorder : const Color(0xFFF3F4F6);

    return Container(

      width: 192,

      margin: const EdgeInsets.only(left: 16.0), // For horizontal spacing between cards
