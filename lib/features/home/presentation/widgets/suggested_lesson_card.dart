...
class SuggestedLessonCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cardColor =
        isDarkMode ? AppColors.darkSurface : const Color(0xFFF3F4F6);
    ...
    return SizedBox(
      ...
      child: Card(
        ...
        margin: const EdgeInsets.only(
            right: 16), // في وضع RTL ستكون المسافة على اليسار
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color:
                      isDarkMode ? AppColors.darkBorder : imagePlaceholderColor,
