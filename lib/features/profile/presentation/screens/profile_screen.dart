...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _loadProfileData() {
    ...
    if (_isMyProfile) { // My Profile

        _profileData = UserProfile(id: 'my_id', name: 'Dr. Youssef Ben Ali', userType: 'publisher', isVerified: true);

    } else { // Other User's Profile

        _profileData = UserProfile(id: 'some_other_id', name: 'Dr. Youssef Ben Ali', userType: 'publisher', isVerified: true);
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      length: _profileData.userType == 'publisher' ? 4 : 0, // 4 tabs for publisher, 0 for student
        ...
        body: CustomScrollView(
          ...
          slivers: <Widget>[
            ...
            SliverToBoxAdapter(
              ...
              child: ProfileHeader(user: _profileData, isMyProfile: _isMyProfile),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Saved Content", style: Theme.of(context).textTheme.headlineSmall),
