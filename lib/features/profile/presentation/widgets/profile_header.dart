        ...
        children: [
            ...
            children: [
              ...
              CircleAvatar(
                ...
                child: const CircleAvatar(
                  ...
                  backgroundImage: NetworkImage("https://placehold.co/96x96/4299E1/FFFFFF?text=Y"),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      if (user.isVerified) SvgPicture.asset(AppIcons.verifiedBadge, height: 20),
          ...
          Wrap(
            ...
            children: [
              ...
              RoleBadge(label: "Teacher", svgPath: AppIcons.roleTeacher, color: AppColors.primaryBlue),

              RoleBadge(label: "Premium", svgPath: AppIcons.rolePremium, color: AppColors.primaryPurple),
          ...
          if (isMyProfile)
            ...
            Row(
              ...
              children: [
                ...
                Expanded(child: _StyledButton(text: "Follow", onPressed: () {}, isPrimary: true)),

                const SizedBox(width: 8),

                Expanded(child: _StyledButton(text: "Message", onPressed: () {}, isPrimary: false)),
            ...
            children: [
              ...
              const CircleAvatar(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: NetworkImage("https://placehold.co/96x96/8B5CF6/FFFFFF?text=A"),
...
class RoleBadge extends StatelessWidget {
  ...
  const RoleBadge({super.key, required this.label, required this.svgPath, required this.color});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          SvgPicture.asset(svgPath, height: 14, width: 14, colorFilter: ColorFilter.mode(color, BlendMode.srcIn)),
      ...
      child: Row(
        ...
        children: [
          ...
          SvgPicture.asset(
            ...
            userType == 'publisher' ? AppIcons.levelPublisher : AppIcons.levelStudent,
          ...
          Text("LVL $level", style: TextStyle(fontWeight: FontWeight.bold, color: Theme.of(context).textTheme.bodyLarge?.color)),
...
class _XpBar extends StatelessWidget {
  ...
  const _XpBar({super.key, required this.currentXp, required this.requiredXp, required this.label});
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text(label, style: TextStyle(color: AppColors.primaryBlue, fontWeight: FontWeight.bold)),

            Text("$currentXp / $requiredXp XP", style: const TextStyle(fontSize: 12, color: Colors.grey)),
...
class _StyledButton extends StatelessWidget {
  ...
  const _StyledButton({super.key, required this.text, required this.onPressed, this.isPrimary = true});
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = isPrimary 
      ...
      : (isDarkMode ? AppColors.darkSurface : AppColors.primaryBlue.withOpacity(0.1));
    ...
    final textColor = isPrimary 
      ...
      : (isDarkMode ? AppColors.darkTextPrimary : AppColors.primaryBlue);
